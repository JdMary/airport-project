...
namespace AM.ApplicationCore.Domaines
{
    public static class TestData
    {
        ...
        public static Plane BoingPlane = new Plane { PlaneType = (Domaine.PlaneType)PlaneType.Boeing, Capacity = 150, ManufactureDate = new DateTime(2015, 02, 03) };
        public static Plane Airbusplane = new Plane { PlaneType = (Domaine.PlaneType)PlaneType.Airbus, Capacity = 250, ManufactureDate = new DateTime(2020, 11, 11) };
        // Staffs
       ...
       ,
        ...
        public static Flight flight2 = new Flight { FlightDate = new DateTime(2022, 01, 02, 21, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 02, 01, 23, 10, 10), EstimatedDuration = 105, Plane = BoingPlane };
        public static Flight flight3 = new Flight { FlightDate = new DateTime(2022, 01, 03, 5, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 03, 01, 6, 40, 10), EstimatedDuration = 100, Plane = BoingPlane };
        public static Flight flight4 = new Flight { FlightDate = new DateTime(2022, 01, 04, 6, 10, 10), Destination = "Madrid", EffectiveArrival = new DateTime(2022, 04, 01, 8, 10, 10), EstimatedDuration = 130, Plane = BoingPlane };
        public static Flight flight5 = new Flight { FlightDate = new DateTime(2022, 01, 05, 17, 10, 10), Destination = "Madrid", EffectiveArrival = new DateTime(2022, 05, 01, 18, 50, 10), EstimatedDuration = 105, Plane = BoingPlane };
        public static Flight flight6 = new Flight { FlightDate = new DateTime(2022, 01, 06, 20, 10, 10), Destination = "Lisbonne", EffectiveArrival = new DateTime(2022, 06, 01, 22, 30, 10), EstimatedDuration = 200, Plane = Airbusplane };
